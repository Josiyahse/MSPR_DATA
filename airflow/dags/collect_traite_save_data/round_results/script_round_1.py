...
def clean_and_transform_data():
  ...
  df_candidates = df_candidates[
    ['department_id', 'candidate_id', 'votes', 'vote_per_subscribe', 'vote_per_express', 'round']]
...
dag = DAG("election_data_processing", default_args=default_args, schedule_interval="@daily")
